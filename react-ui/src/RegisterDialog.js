...
class RegisterDialog extends React.Component{
    ...
    render(){
        return (
            <Modal defaultOpen={true} closeOnDimmerClick={false} closeOnDocumentClick={false}
                closeOnEscape={false}
                closeOnRootNodeClick={false}
            >
                <Modal.Header>There's one more step...</Modal.Header>
                <Modal.Content>
                <Modal.Description>
                    <Form onSubmit={this.submitForm}>
                        <Form.Group widths='equal'>
                            ...
                            onChange={this.handleChange} error={this.state['error']['age']}   />
                        </Form.Group>
                        <Form.Group widths='equal'>
                            <Form.Input label='Weight' name="weight" type="number" placeholder='Weight' error={this.state['error']['weight']}  onChange={this.handleChange}/>
                            <Form.Select label='Weight Unit' name="weight_unit" placeholder="Weight Unit" options={[
                                ...
                                error={this.state['error']['weight_unit']}   />
                        </Form.Group>
                        <Form.Group widths='equal'>
                            <Form.Input label='Height' name="height" type="number" placeholder='Height' error={this.state['error']['height']}    onChange={this.handleChange} />
                        ...
                        <Form.Field>
                                <Form.Select label='Activity Type' name="activity_type" error={this.state['error']['activity_type']} placeholder="Activity Type" options={[
